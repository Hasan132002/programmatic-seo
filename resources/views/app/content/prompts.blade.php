<x-app-layout>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div class="min-w-0">
                <nav class="flex items-center gap-1.5 text-xs text-gray-400 mb-1">
                    ...
                    <svg class="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>
                    <span class="text-gray-500 font-medium">Prompt Templates</span>
                </nav>
                <h1 class="text-lg font-bold text-gray-900 leading-tight">Prompt Template Editor</h1>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <livewire:app.content.prompt-editor :site="$site" />
        </div>
    </div>
</x-app-layout>
