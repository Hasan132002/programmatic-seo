<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3">
            ...
            <nav class="flex items-center gap-2 text-sm">
                ...
                <svg class="w-4 h-4 text-gray-300" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>
                <span class="text-gray-600 font-medium">Create New Page</span>
            </nav>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Create New Page</h2>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <livewire:app.pages.page-editor :site="$site" />
        </div>
    </div>
</x-app-layout>
