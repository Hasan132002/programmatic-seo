<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3">
            ...
            <nav class="flex items-center gap-2 text-sm">
                ...
                <span class="text-gray-600 font-medium">Create New Site</span>
            </nav>
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Create New Site</h2>
                    <p class="text-sm text-gray-500">Set up a new programmatic SEO site in minutes.</p>
                </div>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <livewire:app.sites.create-site />
        </div>
    </div>
</x-app-layout>
