<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">URL Redirects</h2>
                <p class="text-sm text-gray-500 mt-1">{{ $site->name }} &middot; Manage URL redirections</p>
            </div>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @livewire('app.s-e-o.redirect-manager', ['site' => $site])
        </div>
    </div>
</x-app-layout>
